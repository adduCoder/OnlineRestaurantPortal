...
public class GlobalExceptionHandlerTest {
  ...
  public void testHandleAlreadyExists() {
    AlreadyExistsException ex = new AlreadyExistsException("Resource already exists");
  ...
  public void testHandleOperationNotAllowed() {
    OperationNotAllowedException ex = new OperationNotAllowedException("Operation not allowed");
